...
(define (list-of-values exps env)
  (if (no-operands? exps)
      '()
      (cons (myeval (first-operand exps) env) (list-of-values (rest-operands exps) env))))
...
(myeval '(+ 3 4) the-global-environment)

(myeval '(((lambda (x) (lambda (y) (+ x y))) 3) 4) the-global-environment)
